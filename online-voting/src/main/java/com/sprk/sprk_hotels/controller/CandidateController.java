...
public class CandidateController {
    ...
    public String showCandidateById(@PathVariable(name = "id") String idStr, Model model, RedirectAttributes redirectAttributes) {

        String regex = "^\\d+$";
        if (Pattern.matches(regex, idStr)) {
            int id = Integer.parseInt(idStr);
            Candidate candidate = candidateService.getListingById(id);
